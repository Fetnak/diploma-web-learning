<template>
  <the-header header="Группы"></the-header>
  <el-button type="primary" style="margin-left: 1.2rem; margin-top: 1.125rem" @click="submitAdd()">Добавить группу</el-button>

  <el-drawer v-model="drawer" title="Добавить группу" :with-header="false">
    <el-form ref="formRef" class="form" label-position="top" :model="form" :rules="rules">
      ...
      <el-form-item label="Специальность" prop="specialty">
        <el-input v-model="form.specialty" :disabled="disable.specialty" maxlength="255" clearable></el-input>
      </el-form-item>
      <el-form-item label="Специализация" prop="specialization">
        <el-input v-model="form.specialization" :disabled="disable.specialization" maxlength="255" clearable></el-input>
      </el-form-item>
      <el-form-item label="Квалификация" prop="qualification">
        <el-input v-model="form.qualification" :disabled="disable.qualification" maxlength="255" clearable></el-input>
      </el-form-item>
      <el-form-item>
        <div>
      ...
      <el-main style="border-right: none">
        <el-scrollbar>
          <el-table :data="filterTableData" border stripe highlight-current-row style="width: 100%">
            <el-table-column fixed="left" sortable prop="_name" label="Группа" width="200ch" />
            <el-table-column sortable prop="specialty" label="Специальность" />
            <el-table-column sortable prop="specialization" label="Специализация" />
            <el-table-column sortable prop="qualification" label="Квалификация" width="300ch" />
    ...
    const filterTableData = computed(() =>
      tableData.value.filter(
        (data) =>
          !search.value ||
          data._name
            .concat(data.specialty, data.specialization, data.qualification)
            .toLowerCase()
